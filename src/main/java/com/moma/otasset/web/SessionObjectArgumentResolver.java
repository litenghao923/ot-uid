...
public class SessionObjectArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public boolean supportsParameter(MethodParameter parameter) {
        return parameter.getParameterType().equals(SessionObject.class);
    }
    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer, NativeWebRequest webRequest, WebDataBinderFactory binderFactory) throws Exception {
        String attrName = "sessionObj";
        Object sessionObj = webRequest.getAttribute(attrName, RequestAttributes.SCOPE_SESSION);
        if (sessionObj == null) {
